...
2. **GSD Pipeline Commands** (new section, after Development Workflow):
   Add a concise reference to all available GSD skills:
   - /gsd:new-project — Initialize .planning/ with intensive questioning
   ...
   - /gsd:execute-phase N — Execute plans with wave-based parallel execution
   - /gsd:verify-phase N — Goal-backward verification of phase completion
